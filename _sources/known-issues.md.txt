...
There seems to be a limit of 10,000,000 cells in a spreadsheet, and this number applies to the total _across all sheets in a given spreadsheet_. If you keep all your results in a single Google spreadsheet and just keep adding new sheets/tabs to the same single spreadsheet, you can actually hit this limit if you have Boffo return a lot of columns and a lot of results all the time. So just be mindful of this possibility. (The easiest solution is not to create new spreadsheets every once in a while.)
