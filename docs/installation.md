...
Note that after you install Boffo as an add-on in a Google Sheet, Google will show a dialog titled "Boffo has been installed!" that looks like this:
...
3. Right-click over the apps script project named "Boffy (public copy)" and select _Make a copy_ from the contextual menu that pops up.<p align="center"><img width="800px" src="_static/media/google-drive-make-copy.jpg"></p>
