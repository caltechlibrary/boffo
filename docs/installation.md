...
If you are not at Caltech, you will not be able find Boffo in the Google Markplace for add-ons. Instead, you will have to use install the code from the source files in some way. The following subsections describe two possible methods.
